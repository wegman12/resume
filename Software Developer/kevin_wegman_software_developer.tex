...
\section{Experience}
  ...
  \resumeSubheading
    ...
    {Senior Software Developer}{November 2023 - Present}
    \resumeItemListStart
...
\begin{itemize}[leftmargin=0.15in, label={}]
   \small{\item{
    ...
    \textbf{Frameworks and Libraries}{: ASP.NET, VueJS (2 and 3), NUnit, Moq, Vitest, Axios, Electron, Vuetify, Entity Framework, Razor, Dapper, MSSQL, PostgreSQL, Kafka} \\
